...
//        });
    ...
    public void scroll(View v) {
        ...
        Toast.makeText(certificate.this, "cliked andriod_app_devlopment :" + count1, Toast.LENGTH_LONG).show();
    ...
    public void scroll1(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Adavanced Analysis :" + count2, Toast.LENGTH_LONG).show();
    ...
    public void scroll2(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Business Reasearch :" + count3, Toast.LENGTH_LONG).show();
        gotoUrl("https://courseware.cutm.ac.in/courses/business-analytics/");
    }
    ...
    public void scroll3(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Anesthsia for specality surgeries :" + count4, Toast.LENGTH_LONG).show();
    ...
    public void scroll4(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Aero dynamic:" + count5, Toast.LENGTH_LONG).show();
    ...
    public void scroll5(View v) {
        ...
        Toast.makeText(certificate.this, "clicked Biochemistry :" + count6, Toast.LENGTH_LONG).show();
    ...
    public void scroll6(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Business Law:" + count7, Toast.LENGTH_LONG).show();
    ...
    public void scroll7(View v) {
        ...
        Toast.makeText(certificate.this, "cliked 3D Game Art :" + count8, Toast.LENGTH_LONG).show();
    ...
    public void scroll8(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Adavanced Extraction Technologies :" + count9, Toast.LENGTH_LONG).show();
    ...
    public void scroll9(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Camera operator :" + count10, Toast.LENGTH_LONG).show();
    ...
    public void scroll10(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Banking Law and Practice :" + count11, Toast.LENGTH_LONG).show();
    ...
    public void scroll11(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Animation:" + count12, Toast.LENGTH_LONG).show();
    ...
    public void scroll12(View v) {
        ...
        Toast.makeText(certificate.this, "cliked IT infrastructure and management :" + count13, Toast.LENGTH_LONG).show();
    ...
    public void scroll13(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Accounting for managers :" + count14, Toast.LENGTH_LONG).show();
    ...
    public void scroll14(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Contact Lens :" + count15, Toast.LENGTH_LONG).show();
    ...
    public void scroll15(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Adavance Web Programming :" + count16, Toast.LENGTH_LONG).show();
    ...
    public void scroll16(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Accident Investigation :" + count17, Toast.LENGTH_LONG).show();
    ...
    public void scroll17(View v) {
        ...
        Toast.makeText(certificate.this, "cliked CNC programmng :" + count18, Toast.LENGTH_LONG).show();
    ...
    public void scroll18(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Digital Painiting :" + count19, Toast.LENGTH_LONG).show();
    ...
    public void scroll19(View v) {
        ...
        Toast.makeText(certificate.this, "cliked Crime and society:" + count20, Toast.LENGTH_LONG).show();
...
//                Toast.makeText(certificate.this, "Time :"+str, Toast.LENGTH_SHORT).show();
//
//
//            }
//        });
